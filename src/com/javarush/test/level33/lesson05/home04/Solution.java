...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        String json2 = json.substring(0,json.indexOf(":")+2) + resultClassObject.getSimpleName().toLowerCase() + json.substring(json.indexOf(",")-1);
        StringReader reader = new StringReader(json2);
