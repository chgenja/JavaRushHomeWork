...
public class Solution
{
    ...
    public static boolean checkTelNumber(String telNumber)
    {
        ...
        {
            if (!telNumber.matches("\\+\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*"))
                return false;
        } else if (telNumber.charAt(0) == 45)
            return false;
        else {
            if (!telNumber.matches("\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*\\d\\D*"))
                return false;
        }
