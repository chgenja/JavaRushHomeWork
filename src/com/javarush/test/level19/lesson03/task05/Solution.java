...
public class Solution {
    ...
    public static class DataAdapter implements RowItem {
        ...
        public String getDialString()
        {
            ...
            return "callto://" + s.substring(0,s.indexOf("(")) + s.substring(s.indexOf("(")+1,s.indexOf(")")) + s.substring(s.indexOf(")")+1,s.indexOf("-")) + s.substring(s.indexOf("-")+1,s.lastIndexOf("-"))+s.substring(s.lastIndexOf("-")+1);
        }
    }
