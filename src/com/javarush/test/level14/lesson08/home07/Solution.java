...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (Apartament house : apartaments)
        {
            if (house instanceof Apt1Room)
            {
                Apt1Room apt = new Apt1Room();
                apt.clean1Room();
            }
            else if (house instanceof Apt2Room)
            {
                Apt2Room apt = new Apt2Room();
                apt.clean2Rooms();
            }
            else if (house instanceof Apt3Room)
            {
                Apt3Room apt = new Apt3Room();
                apt.clean3Rooms();
            }
        }
    }
